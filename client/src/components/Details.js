...
console.log(foundSauce)
    return(
        <div className="bg-light py-3 text-center">
            ...
            <div>
                {!!foundSauce && foundSauce.imageUrl && foundSauce.imageUrl !== null ? (
                    <img src={foundSauce.imageUrl} className="details-pic" />
                  ) : (
            ...
            <h5>Heat Rating (Scoville Units):{!!foundSauce && foundSauce.heatRating}</h5>
