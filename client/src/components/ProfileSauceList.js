...
//                     {imageUrl ? (
//                         <img src={imageUrl} alt="" className="submitted-pic card-img-top cardsize" />
//                     ) : (
//                         <img src={pepper} alt="" className="pepper submitted-pic card-img-top cardsize"/>
//                     )
//                     }       
//                     <br></br>
//                     <br></br>
...
function ProfileSauceList(props) {
    ...
    const handleDetailsClick = (sauceId) => console.log('details');navigate(`details/${_id}`) ;
